...
echo "[openssh-pkcs11] Applying ML-DSA-44/65/87 (draft-sfluhrer-ssh-mldsa-08) +"
echo "[openssh-pkcs11] SLH-DSA 8-parameter-set (draft-josefsson-ssh-sphincs-02) patches..."
