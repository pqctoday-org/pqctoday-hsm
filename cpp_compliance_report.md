...
**Engine commit:** `181ddb137f05120156750660c78bb1121d823947`
**Date:** 2026-09-13 21:07:32 UTC
...
| Test | Status | Details |
|---|---|---|
| Child_survived_and_reported | ✅ PASS | child pid 378222 exited status 0 |
...
| Sibling_children_RNG_diverge | ✅ PASS | 8 sibling pairs, all distinct=1 childA=B0750E4C0FC103D6… childB=CCAEA938C11B656C… (identical output would repeat ECDSA nonces) |
...
| Parent_and_child_RNG_diverge | ✅ PASS | child=8C00F5B56F5B1348… parent=8CFE65385E0AB9B0… preFork=18833DE60964E442… |
...
| Test | Status | Details |
|---|---|---|
| AES_Generate_KCV_Present | ✅ PASS | 3 bytes: 3BDA72 |
| AES_Generate_KCV_Equals_OracleEcbZeroBlock | ✅ PASS | HSM=3BDA72 == oracle=3BDA72 |
| AES_Unwrap_KCV_Present | ✅ PASS | 3 bytes: 1C7B63 |
| AES_Unwrap_KCV_Equals_Original | ✅ PASS | original=1C7B63 unwrapped=1C7B63 |
...
| Encap_KCV_equals_SHA1_oracle | ✅ PASS | HSM=E79319 oracle=E79319 |
| Decap_KCV_present | ✅ PASS | got 3 bytes |
| Decap_KCV_equals_SHA1_oracle | ✅ PASS | HSM=E79319 oracle=E79319 |
| Encap_and_Decap_KCV_agree | ✅ PASS | encap=E79319 decap=E79319 |
...
| ECDH_Encap_KCV_equals_SHA1_oracle | ✅ PASS | HSM=D9CD47 oracle=D9CD47 |
| ECDH_Decap_KCV_equals_SHA1_oracle | ✅ PASS | HSM=D9CD47 oracle=D9CD47 |
...
| Test | Status | Details |
|---|---|---|
| GenerateKey_AES_KCV_matches_oracle | ✅ PASS | engine=CCB108 oracle=CCB108 |
...
| GenerateKey_Generic_KCV_matches_oracle | ✅ PASS | engine=D0CFFC oracle=D0CFFC |
...
| UnwrapKey_AES_KCV_matches_oracle | ✅ PASS | engine=FD45C3 oracle=FD45C3 |
| UnwrapKey_AES_correct_value_accepted | ✅ PASS | RV=0 readback=FD45C3 |
...
| DeriveKey_HKDF_KCV_matches_oracle | ✅ PASS | engine=D62DEB oracle=D62DEB |
| DeriveKey_HKDF_correct_value_accepted | ✅ PASS | RV=0 readback=D62DEB |
...
| DeriveKey_ECDH_KCV_matches_oracle | ✅ PASS | engine=B59F1A oracle=B59F1A |
| DeriveKey_ECDH_correct_value_accepted | ✅ PASS | RV=0 readback=B59F1A |
...
| DeriveKey_SP800108_KCV_matches_oracle | ✅ PASS | engine=6BA81E oracle=6BA81E |
| DeriveKey_SP800108_correct_value_accepted | ✅ PASS | RV=0 readback=6BA81E |
...
| DeriveKey_Concat_KCV_matches_oracle | ⚠️ SKIP | CKA_VALUE unreadable (RV=17), engine KCV=68F2AC |
| DeriveKey_Concat_correct_value_accepted | ✅ PASS | RV=0 readback=68F2AC |
...
| DeriveKey_X25519_KCV_matches_oracle | ✅ PASS | engine=1E34C8 oracle=1E34C8 |
| DeriveKey_X25519_correct_value_accepted | ✅ PASS | RV=0 readback=1E34C8 |
...
| ML_DSA_44_CKA_VALUE_not_DER_wrapped | ✅ PASS | first byte=0x84 len=2560 |
...
| ML_KEM_768_CKA_VALUE_not_DER_wrapped | ✅ PASS | first byte=0xfc len=2400 |
| ML_KEM_768_CKA_SEED_contributed | ✅ PASS | RV=0 len=64 (want 64) |
| SLH_DSA_CKA_VALUE_is_raw_FIPS_length | ✅ PASS | len=64 (want 64) |
| SLH_DSA_CKA_VALUE_not_DER_wrapped | ✅ PASS | first byte=0x9f len=64 |
