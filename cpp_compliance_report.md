...
**Engine commit:** `5387ead54f432b129f9ededa6a428b0861591afe`
**Date:** 2026-08-26 23:58:25 UTC
...
| Test | Status | Details |
|---|---|---|
| Child_survived_and_reported | ✅ PASS | child pid 530306 exited status 0 |
...
| Sibling_children_RNG_diverge | ✅ PASS | 8 sibling pairs, all distinct=1 childA=F831F57C17E6D5D5… childB=86A21E4F90E7AAFA… (identical output would repeat ECDSA nonces) |
...
| Parent_and_child_RNG_diverge | ✅ PASS | child=BCE990B4E6879603… parent=9EDE7C3ECD37C49B… preFork=D2F351EFBF8B2308… |
...
| Test | Status | Details |
|---|---|---|
| AES_Generate_KCV_Present | ✅ PASS | 3 bytes: CFF9DB |
| AES_Generate_KCV_Equals_OracleEcbZeroBlock | ✅ PASS | HSM=CFF9DB == oracle=CFF9DB |
| AES_Unwrap_KCV_Present | ✅ PASS | 3 bytes: 8A1B3A |
| AES_Unwrap_KCV_Equals_Original | ✅ PASS | original=8A1B3A unwrapped=8A1B3A |
...
| Encap_KCV_equals_SHA1_oracle | ✅ PASS | HSM=F2D6B9 oracle=F2D6B9 |
| Decap_KCV_present | ✅ PASS | got 3 bytes |
| Decap_KCV_equals_SHA1_oracle | ✅ PASS | HSM=F2D6B9 oracle=F2D6B9 |
| Encap_and_Decap_KCV_agree | ✅ PASS | encap=F2D6B9 decap=F2D6B9 |
...
| ECDH_Encap_KCV_equals_SHA1_oracle | ✅ PASS | HSM=09E0A3 oracle=09E0A3 |
| ECDH_Decap_KCV_equals_SHA1_oracle | ✅ PASS | HSM=09E0A3 oracle=09E0A3 |
...
| Test | Status | Details |
|---|---|---|
| GenerateKey_AES_KCV_matches_oracle | ✅ PASS | engine=9628D9 oracle=9628D9 |
...
| GenerateKey_Generic_KCV_matches_oracle | ✅ PASS | engine=644260 oracle=644260 |
...
| UnwrapKey_AES_KCV_matches_oracle | ✅ PASS | engine=3933C4 oracle=3933C4 |
| UnwrapKey_AES_correct_value_accepted | ✅ PASS | RV=0 readback=3933C4 |
...
| DeriveKey_HKDF_KCV_matches_oracle | ✅ PASS | engine=3BD851 oracle=3BD851 |
| DeriveKey_HKDF_correct_value_accepted | ✅ PASS | RV=0 readback=3BD851 |
...
| DeriveKey_ECDH_KCV_matches_oracle | ✅ PASS | engine=3AC448 oracle=3AC448 |
| DeriveKey_ECDH_correct_value_accepted | ✅ PASS | RV=0 readback=3AC448 |
...
| DeriveKey_SP800108_KCV_matches_oracle | ✅ PASS | engine=ABEC20 oracle=ABEC20 |
| DeriveKey_SP800108_correct_value_accepted | ✅ PASS | RV=0 readback=ABEC20 |
...
| DeriveKey_Concat_KCV_matches_oracle | ⚠️ SKIP | CKA_VALUE unreadable (RV=17), engine KCV=75E289 |
| DeriveKey_Concat_correct_value_accepted | ✅ PASS | RV=0 readback=75E289 |
...
| DeriveKey_X25519_KCV_matches_oracle | ✅ PASS | engine=A0A808 oracle=A0A808 |
| DeriveKey_X25519_correct_value_accepted | ✅ PASS | RV=0 readback=A0A808 |
...
| ML_DSA_44_CKA_VALUE_not_DER_wrapped | ✅ PASS | first byte=0x6c len=2560 |
...
| ML_KEM_768_CKA_VALUE_not_DER_wrapped | ✅ PASS | first byte=0xa2 len=2400 |
| ML_KEM_768_CKA_SEED_contributed | ✅ PASS | RV=0 len=64 (want 64) |
| SLH_DSA_CKA_VALUE_is_raw_FIPS_length | ✅ PASS | len=64 (want 64) |
| SLH_DSA_CKA_VALUE_not_DER_wrapped | ✅ PASS | first byte=0x80 len=64 |
