...
module.exports = Object.freeze({
  ...
  // WS-5.1 (2026-08-30): SHA3-RSA composites — advertised by C++
  // (SoftHSM_slots.cpp) but never had JS constants at all.
  ...
  // PKCS#11 v3.2 §2.44 SP800-108 KDF (pkcs11t.h values, WS-5.2 2026-08-30)
  ...
  // PKCS#11 v3.2 §2.42 digest key derivation (pkcs11t.h values, WS-6.2 2026-08-30)
  ...
  // WS-8 (2026-08-30), pkcs11t.h values
  ...
  // ── HSS / LMS — stateful hash-based signatures (RFC 8554 + SP 800-208) ───
  ...
  // HSS / LMS key attributes (PKCS#11 v3.2 §6.14)
  ...
  // CKF_ARRAY_ATTRIBUTE (0x40000000) — see pkcs11t.h:658; v3.3 corrects a
  // v3.2 omission and governs under the v3.2-baseline/v3.3-fills-gaps rule.
  CKA_ENCAPSULATE_TEMPLATE: 0x4000062a,
  CKA_DECAPSULATE_TEMPLATE: 0x4000062b,
  ...
  // ── LMS parameter sets (IANA registry — RFC 8554 + SP 800-208 §4) ─────────
  // SHA-256/N32 (RFC 8554, tree heights H=5/10/15/20/25)
  CKP_LMS_SHA256_M32_H5:  0x00000005,
  CKP_LMS_SHA256_M32_H10: 0x00000006,
  CKP_LMS_SHA256_M32_H15: 0x00000007,
  CKP_LMS_SHA256_M32_H20: 0x00000008,
  CKP_LMS_SHA256_M32_H25: 0x00000009,
  // SHAKE-256/N32 (SP 800-208)
  CKP_LMS_SHAKE_M32_H5:   0x0000000F,
  CKP_LMS_SHAKE_M32_H10:  0x00000010,
  CKP_LMS_SHAKE_M32_H15:  0x00000011,
  CKP_LMS_SHAKE_M32_H20:  0x00000012,
  CKP_LMS_SHAKE_M32_H25:  0x00000013,

  // ── LMOTS parameter sets (IANA registry — RFC 8554 + SP 800-208 §4) ───────
  // SHA-256/N32 Winternitz widths W=1/2/4/8
  CKP_LMOTS_SHA256_N32_W1: 0x00000001,
  CKP_LMOTS_SHA256_N32_W2: 0x00000002,
  CKP_LMOTS_SHA256_N32_W4: 0x00000003,
  CKP_LMOTS_SHA256_N32_W8: 0x00000004,
  // SHAKE-256/N32 Winternitz widths W=1/2/4/8 (SP 800-208)
  CKP_LMOTS_SHAKE_N32_W1:  0x00000009,
  CKP_LMOTS_SHAKE_N32_W2:  0x0000000A,
  CKP_LMOTS_SHAKE_N32_W4:  0x0000000B,
  CKP_LMOTS_SHAKE_N32_W8:  0x0000000C,
