...
/* remediation R2: PQC decoders — the FORMAT_NAME argument must be the exact
 * single-name string store.c emits as OSSL_OBJECT_PARAM_DATA_TYPE for each
 * variant (filter_for_desired_data_type compares byte-for-byte), NOT the
 * colon-separated P11PROV_NAMES_* registration lists. */
P11PROV_DER_COMMON_DECODE_FN(MLDSA_44, mldsa44)
P11PROV_DER_COMMON_DECODE_FN(MLDSA_65, mldsa65)
P11PROV_DER_COMMON_DECODE_FN(MLDSA_87, mldsa87)
P11PROV_DER_COMMON_DECODE_FN("ML-KEM-512", mlkem512)
P11PROV_DER_COMMON_DECODE_FN("ML-KEM-768", mlkem768)
P11PROV_DER_COMMON_DECODE_FN("ML-KEM-1024", mlkem1024)
P11PROV_DER_COMMON_DECODE_FN(SLHDSA_SHA2_128S, slhdsa_sha2_128s)
P11PROV_DER_COMMON_DECODE_FN(SLHDSA_SHAKE_128S, slhdsa_shake_128s)
P11PROV_DER_COMMON_DECODE_FN(SLHDSA_SHA2_128F, slhdsa_sha2_128f)
P11PROV_DER_COMMON_DECODE_FN(SLHDSA_SHAKE_128F, slhdsa_shake_128f)
P11PROV_DER_COMMON_DECODE_FN(SLHDSA_SHA2_192S, slhdsa_sha2_192s)
P11PROV_DER_COMMON_DECODE_FN(SLHDSA_SHAKE_192S, slhdsa_shake_192s)
P11PROV_DER_COMMON_DECODE_FN(SLHDSA_SHA2_192F, slhdsa_sha2_192f)
P11PROV_DER_COMMON_DECODE_FN(SLHDSA_SHAKE_192F, slhdsa_shake_192f)
P11PROV_DER_COMMON_DECODE_FN(SLHDSA_SHA2_256S, slhdsa_sha2_256s)
P11PROV_DER_COMMON_DECODE_FN(SLHDSA_SHAKE_256S, slhdsa_shake_256s)
P11PROV_DER_COMMON_DECODE_FN(SLHDSA_SHA2_256F, slhdsa_sha2_256f)
P11PROV_DER_COMMON_DECODE_FN(SLHDSA_SHAKE_256F, slhdsa_shake_256f)
...
DISPATCH_DECODER_FN_LIST(der, p11prov, mldsa44);
DISPATCH_DECODER_FN_LIST(der, p11prov, mldsa65);
DISPATCH_DECODER_FN_LIST(der, p11prov, mldsa87);
DISPATCH_DECODER_FN_LIST(der, p11prov, mlkem512);
DISPATCH_DECODER_FN_LIST(der, p11prov, mlkem768);
DISPATCH_DECODER_FN_LIST(der, p11prov, mlkem1024);
DISPATCH_DECODER_FN_LIST(der, p11prov, slhdsa_sha2_128s);
DISPATCH_DECODER_FN_LIST(der, p11prov, slhdsa_shake_128s);
DISPATCH_DECODER_FN_LIST(der, p11prov, slhdsa_sha2_128f);
DISPATCH_DECODER_FN_LIST(der, p11prov, slhdsa_shake_128f);
DISPATCH_DECODER_FN_LIST(der, p11prov, slhdsa_sha2_192s);
DISPATCH_DECODER_FN_LIST(der, p11prov, slhdsa_shake_192s);
DISPATCH_DECODER_FN_LIST(der, p11prov, slhdsa_sha2_192f);
DISPATCH_DECODER_FN_LIST(der, p11prov, slhdsa_shake_192f);
DISPATCH_DECODER_FN_LIST(der, p11prov, slhdsa_sha2_256s);
DISPATCH_DECODER_FN_LIST(der, p11prov, slhdsa_shake_256s);
DISPATCH_DECODER_FN_LIST(der, p11prov, slhdsa_sha2_256f);
DISPATCH_DECODER_FN_LIST(der, p11prov, slhdsa_shake_256f);
