    ...
    while (ctx->fetched < ctx->num_objs) {
        ...
        case CKO_SECRET_KEY:
            ...
            if (ctx->alias) {
                ...
                /* CKA_LABEL per PKCS#11 spec is CK_UTF8CHAR* with no
                 * required NUL terminator. strcmp would read past
                 * label->pValue when the stored label is not NUL-
    ...
    case CKO_PRIVATE_KEY:
        ...
        case CKK_ML_KEM: {
            ...
            case CKP_ML_KEM_512:
                ...
                break;
            case CKP_ML_KEM_768:
                data_type = (char *)"ML-KEM-768";
                break;
            case CKP_ML_KEM_1024:
                data_type = (char *)"ML-KEM-1024";
                break;
            default:
                return RET_OSSL_ERR;
            }
