...
#define CKA_UNIQUE_ID          0x00000017UL
...
/* BIP32 Attributes */
#define CKA_BIP32_CHAIN_CODE   0x00001021UL
#define CKA_BIP32_CHILD_INDEX  0x00001022UL
...
/* BIP32 HD Derivation Mechanisms (from PKCS#11 v3.x profiles) */
