//! Classic McEliece 6688128f — NIST category 5, wide field (GFBITS=13), `f`.
//! Byte-interoperable with 6688128's encapsulate/decapsulate (P0-5).
...
mod tests {
    ...
    #[test]
    #[ignore = "6688128f keygen is minutes-slow in debug builds — run --release"]
