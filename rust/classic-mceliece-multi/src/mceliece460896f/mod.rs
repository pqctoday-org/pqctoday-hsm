//! Classic McEliece 460896f — NIST category 3, wide field (GFBITS=13), `f`.
//! Byte-interoperable with 460896's encapsulate/decapsulate (P0-5).
...
mod tests {
    ...
    #[test]
    #[ignore = "460896f keygen is slow in debug builds — run --release"]
