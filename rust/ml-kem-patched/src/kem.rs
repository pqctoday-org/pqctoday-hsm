...
fn mlkem_name<P: KemParams>() -> &'static str {
    ...
    P: KemParams,
{
    ...
    fn decapsulate(&self, encapsulated_key: &EncodedCiphertext<P>) -> Result<SharedKey, ()> {
        #[cfg(feature = "phase-profile")]
        let _pqc_operation = pqc_phase_profile::operation(mlkem_name::<P>(), "decaps");
    ...
    P: KemParams,
{
    ...
    pub(crate) fn generate_deterministic(d: &B32, z: &B32) -> Self {
        #[cfg(feature = "phase-profile")]
        let _pqc_operation = pqc_phase_profile::operation(mlkem_name::<P>(), "keygen");
    ...
    P: KemParams,
{
    ...
    fn encapsulate_deterministic_inner(&self, m: &B32) -> (EncodedCiphertext<P>, SharedKey) {
        #[cfg(feature = "phase-profile")]
        let _pqc_operation = pqc_phase_profile::operation(mlkem_name::<P>(), "encaps");
        let (K, r) = G(&[m, &self.h]);
