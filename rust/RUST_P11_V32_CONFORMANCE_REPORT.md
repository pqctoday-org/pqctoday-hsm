...
**Engine commit:** `636b013ef833` · **Generated:** 2026-08-31T14:56:51.484Z — machine-written
...
**999 passed / 0 failed** across 51 sections in this JS harness.
...
- G9 — advertise-vs-dispatch invariant: every advertised mechanism has a real dispatch path (new) (216 passed / 0 failed)
...
── F1 — mechanism table reconciliation (R6.2) ──
  ✅ all 129 advertised mechanisms answerable → 0 missing
...
── G9 — advertise-vs-dispatch invariant: every advertised mechanism has a real dispatch path (new) ──
  ✅ fixture: live advertised mechanism count → 129
  ...
  ✅ G9: probed at least one real operation for every flag-bearing advertised mechanism (214 probes total)

════════ RESULT: 999 passed, 0 failed ════════
```
