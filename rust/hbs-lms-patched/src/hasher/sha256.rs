...
define_sha!(Sha256_256, 32, 0x05, 0x01); // SP 800-208: LMS_SHA256_M32_*, LMOTS_SHA256_N32_*

define_sha!(Sha256_192, 24, 0x0A, 0x05); // SP 800-208: LMS_SHA256_M24_*, LMOTS_SHA256_N24_*

define_sha!(Sha256_128, 16, 0x05, 0x01); // no IANA assignment — keeps legacy ids
