...
| PBKDF2 (`CKM_PKCS5_PBKD2`) | Not supported | **Implemented** — HMAC-SHA{1/224/256/384/512} PRF; BIP39 / SLIP-0010 seed derivation; token policy: iteration count ≥ 1000 (NIST SP 800-132 §5.2), lower counts refused with `CKR_ARGUMENTS_BAD` |
...
// recommended minimum); a lower count returns CKR_ARGUMENTS_BAD
